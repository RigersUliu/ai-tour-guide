    ...
    <footer className="bg-gray-800 text-white mt-16">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/map" className="hover:text-white">Destinations</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              <li><Link href="/chat/shkodra" className="hover:text-white">Shkodra</Link></li>
              <li><Link href="/chat/tirana" className="hover:text-white">Tirana</Link></li>
              <li><Link href="/chat/vlora" className="hover:text-white">Vlora</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2025 Albania Tour Guide. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
